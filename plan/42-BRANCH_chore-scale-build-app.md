...
- **BR-42h `feat/harness-followons`** — *Purpose*: the `@sentropic/harness` follow-ons handed to
  ...
  BR-42i's manifest, ZERO rework), `stp scope check` router, harness `discipline` layer (full
  superpowers-surface coverage — **BR-42k dissolved into it**), genericity G1–G6, enforcement
