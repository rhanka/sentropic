...
- [ ] **Lot 0 - Baseline & constraints**
  ...
  - [ ] Create isolated worktree `tmp/feat-image-generation-tool` from `main`.
  ...
  - [ ] Capture Makefile targets needed for API, UI, package, AI, and E2E gates.
  - [ ] Confirm command style with `API_PORT=9191`, `UI_PORT=5391`, `MAILDEV_UI_PORT=1291`, and the concrete `ENV=...` value last.
  - [ ] Confirm scope boundaries and declare `BR38b-EXn` before touching conditional paths.
