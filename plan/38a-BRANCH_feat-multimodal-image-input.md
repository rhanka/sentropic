...
- [ ] **Lot 0 - Baseline & constraints**
  ...
  - [ ] Create isolated worktree `tmp/feat-multimodal-image-input` from `main`.
  ...
  - [ ] Capture Makefile targets needed for API, UI, package, and E2E gates.
  - [ ] Confirm command style with `API_PORT=9190`, `UI_PORT=5390`, `MAILDEV_UI_PORT=1290`, and the concrete `ENV=...` value last.
  - [ ] Confirm scope boundaries and declare `BR38a-EXn` before touching conditional paths.
