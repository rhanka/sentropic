...
- **BR19-N4 — Vocabulary cleanup per glossary (2026-05-22)**
  ...
  - Anchor (out of scope for BR19, follow-up branch): the glossary spec should be extended with a "Banned synonyms" table + a `make vocab-check` CI target. Tracked outside BR19 as `chore/vocab-policy` (touches `Makefile` + `.github/workflows/**`, both forbidden here).
