# @sentropic/mcp-connector-linear

BR-72 benchmark proof: a READ-ONLY Linear connector adapter recoded independently
...
the BR-72 matrix §7 linear read-only rows — it is NOT a shipped production connector, and the
