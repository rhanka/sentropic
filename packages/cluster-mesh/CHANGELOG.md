...
- Accept an injected NHI lifecycle, retaining the command-runner default.
- Forward optional attestation role/scope and delegate optional device denial.
- Validate optional signed-projection expiry on creation and resolution.
- Export `verifyCustodySignature` from the package root.
