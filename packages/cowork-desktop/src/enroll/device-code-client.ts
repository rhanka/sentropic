...
export interface DeviceCodeClientDeps {
    ...
    /**
     * Enrollment attestation for the Option-B benign kiosk.  A normal desktop
     * is never silently treated as a remote-control target.
     */
    capabilities?: {
        capabilityIds: Array<'screen_capture' | 'input_action'>;
...
export class DeviceCodeClient {
    ...
    private readonly capabilities: NonNullable<DeviceCodeClientDeps['capabilities']>;
