...
describe('ChatConversation — export surface registration', () => {
  ...
  it('should have version 0.16.0 in package.json (minor — context module + D7 tool-scope split)', () => {
    expect(pkgJson.version).toBe('0.16.0');
  });

  it('should have _version 0.16.0 in export-manifest.json', () => {
    expect(manifest._version).toBe('0.16.0');
  });
