...
describe('ChatConversation — export surface registration', () => {
  ...
  it('should have version 0.12.0 in package.json (minor bump — feat/chatui-conversation-wiring real stream + local-tool dispatch)', () => {
    expect(pkgJson.version).toBe('0.12.0');
  });

  it('should have _version 0.12.0 in export-manifest.json', () => {
    expect(manifest._version).toBe('0.12.0');
  });
