...
describe('ChatConversation — export surface registration', () => {
  ...
  it('should have version 0.9.1 in package.json (patch bump — BR-14e ai-priorities tool-scope rename)', () => {
    expect(pkgJson.version).toBe('0.9.1');
  });

  it('should have _version 0.9.1 in export-manifest.json', () => {
    expect(manifest._version).toBe('0.9.1');
  });
