...
describe('ChatCoreHost — export surface registration', () => {
  ...
  it('should have version 0.32.1 in package.json', () => {
    expect(pkgJson.version).toBe('0.32.1');
  });

  it('should have _version 0.32.1 in export-manifest.json', () => {
    expect(manifest._version).toBe('0.32.1');
  });
