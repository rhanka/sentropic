...
describe('documents module — export surface registration', () => {
  ...
  it('should have version 0.23.1 in package.json (minor — gold shell ChatPanelShell/ChatSessionsBar extraction)', () => {
    expect(pkgJson.version).toBe('0.23.1');
  });

  it('should have _version 0.23.1 in export-manifest.json', () => {
    expect(manifest._version).toBe('0.23.1');
  });
