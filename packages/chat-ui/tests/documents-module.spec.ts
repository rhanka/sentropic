...
describe('documents module — export surface registration', () => {
  ...
  it('should have version 0.26.0 in package.json (minor — gold shell ChatPanelShell/ChatSessionsBar extraction)', () => {
    expect(pkgJson.version).toBe('0.26.0');
  });

  it('should have _version 0.26.0 in export-manifest.json', () => {
    expect(manifest._version).toBe('0.26.0');
  });
