...
export const createDefaultAuthUiLabels = (overrides: Partial<AuthUiLabels> = {}): AuthUiLabels => ({
  ...
  federationDividerLabel: 'or',
  federationContinueWith: 'Continue with {label}',
  identitiesTitle: 'Linked accounts',
  identitiesSubtitle: 'Sign in faster by linking a social or enterprise account.',
  identitiesEmpty: 'No linked accounts yet.',
  identitiesLinkedOn: 'Linked on {date}',
  identitiesUnlink: 'Unlink',
  identitiesUnlinkLastFactor: 'You cannot unlink your only sign-in method.',
  identitiesConfirmUnlink: 'Unlink {provider}? You will no longer be able to sign in with it.',
  identitiesErrorUnlink: 'Failed to unlink the account.',
  identitiesLinkAnother: 'Link another account',
  identitiesLinkButton: 'Link {label}',
  ...overrides,
});
...
export const createFrenchAuthUiLabels = (overrides: Partial<AuthUiLabels> = {}): AuthUiLabels =>
  createDefaultAuthUiLabels({
    ...
    federationDividerLabel: 'ou',
    federationContinueWith: 'Continuer avec {label}',
    identitiesTitle: 'Comptes liés',
    identitiesSubtitle: 'Connectez-vous plus vite en liant un compte social ou professionnel.',
    identitiesEmpty: 'Aucun compte lié.',
    identitiesLinkedOn: 'Lié le {date}',
    identitiesUnlink: 'Délier',
    identitiesUnlinkLastFactor: 'Vous ne pouvez pas délier votre seule méthode de connexion.',
    identitiesConfirmUnlink: 'Délier {provider} ? Vous ne pourrez plus vous connecter avec ce compte.',
    identitiesErrorUnlink: 'Échec de la dissociation du compte.',
    identitiesLinkAnother: 'Lier un autre compte',
    identitiesLinkButton: 'Lier {label}',
    ...overrides,
  });
