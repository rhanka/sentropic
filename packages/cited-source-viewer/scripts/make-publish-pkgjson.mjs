#!/usr/bin/env node
/**
 * make-publish-pkgjson.mjs — publish-time package.json rewriter (chat-ui BR-PKG-EX1 pattern, adopted for cited-source-viewer (BR-CSVP-EX1))
 *
 * The repo/workspace package.json stays src-form (exports -> ./src/...) so the
 * workspace typecheck/build/cowork jobs resolve cited-source-viewer from source as before.
 ...
 *
 * Usage (run from packages/cited-source-viewer/):
