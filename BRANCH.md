...
- [ ] Lot N: final validation, UAT, PR
  ...
  - [x] AI shard `initiative-generation-async` classified FLAKY (see BR14e-F28); non-blocking per AI flaky allowlist; user sign-off required before merge.
