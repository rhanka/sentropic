...
- [ ] Lot N: final validation, UAT, PR
  ...
  - [ ] `make clean test-e2e API_PORT=8714 UI_PORT=5114 MAILDEV_UI_PORT=1014 ENV=e2e-br14e` (BR14e-F21 open; rerun required on current HEAD)
  - [x] AI shard `initiative-generation-async` classified FLAKY (see BR14e-F28); non-blocking per AI flaky allowlist; user sign-off GRANTED 2026-06-01.
