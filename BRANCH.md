...
- [ ] **Lot 3 — Live poc-k8s UAT**
  ...
  - [x] Attempt real outbound verification email smoke to `fabien.antoine@gmail.com`; the api reached the mail send path but returned HTTP 500 because SMTP egress from the k8s pod times out.
