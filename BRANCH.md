...
- [ ] **Lot 24 — `/config` TARGET configuration router extraction**
  - [ ] Phase A: close the Fable Lot 23 re-review conditions before config extraction.
    ...
    - [ ] Cold-start and stop the API-only stack on reserved ports with raw health/auth/duplicate-prefix/control-unavailable evidence; claim no UI execution.
