...
- [x] **Lot 4 — Sentropic host adapter + ports wiring + UI thin wrappers**
  ...
  - [x] Lot 4 gate:
    ...
    - [x] End-of-lot cleanup: `make down ENV=test-feat-auth-oidc`.
  - [x] Commit (split ≤150 lines): split into `aa7a25d2`, `a3e97904`, `48ee2ed3`, `346859e6`, `a8469e47`.

- [x] **Lot 5 — Mock RP integration proof (in-process, no host)**
  - [x] Create `packages/auth-hono/tests/example-oauth-rp.test.ts`:
  ...
  - [x] Lot 5 gate:
    - [x] `make test-auth-hono SCOPE=packages/auth-hono/tests/example-oauth-rp.test.ts ENV=test-feat-auth-oidc`
    - [x] `make build-auth-hono ENV=test-feat-auth-oidc`
    - [x] End-of-lot cleanup: `make down ENV=test-feat-auth-oidc`.
