...
- **Exception process**:
  ...
  - [x] `BR-L2E1-EX2` is declared below before the API compiler-resolution edit.
  - [x] `BR42-EX2` mirrors `BR-L2E1-EX2` solely for this checkout's numeric harness exception parser.
