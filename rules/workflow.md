...
- Frozen packages (`auth-hono`, `build-cli`, `focus`) are not bootstrap targets (no dispatch option, no guard allow-list entry, no bootstrap step) until the owner decides.
