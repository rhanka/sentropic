...
import {
    ...
    policyKey,
    resolveMatchingPolicy as resolveMatchingPolicyFromEntries,
...
// Re-export the portable permission schema under the historical names so
...
const resolveMatchingPolicy = (
    ...
    resolveMatchingPolicyFromEntries(policiesByKey.values(), toolName, runtimeOrigin);
